    ...
    $(function () {
        var table = $('#kt_datatable').DataTable({
          ...
          columns: [
              ...
              {data: 'price_after_discount', name: 'price_after_discount', defaultContent: "__"},
              {data: 'flag', name: 'flag', defaultContent: "__"},
              {data: 'category.name', name: 'category.name', defaultContent: "__"},
...
<script>
    $(document).on('click','.edit_item_btn',function (e) {
       ...
       var id = $(this).data("id");
        $.ajax({
            url: $("meta[name='BASE_URL']").attr("content") + '/admin/products/' + id + '/edit', 
            type: "get", 
...
<script>
    $(document).on('click','.create_item_btn',function (e) {
       ...
       var id = $(this).data("id");
        $.ajax({
            url: $("meta[name='BASE_URL']").attr("content") + '/admin/products/create', 
            type: "get", 
            success: function (response) {
                if(response.code ==200){
