...
<html lang="en">
	...
	<head><base href="../../../../">
		...
		<link href="{{asset('/public/assets/css/pages/login/classic/login-1.css')}}" rel="stylesheet" type="text/css" />
		...
		<!--end::Layout Themes-->
		{{-- <link rel="shortcut icon" href="{{asset('/public/assets/media/logos/Metrical.png')}}" /> --}}
	</head>
	<!--end::Head-->
	<!--begin::Body-->
	<body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading">
		...
		<div class="d-flex flex-column flex-root">
			...
			<div class="login login-1 login-signin-on d-flex flex-column flex-lg-row flex-column-fluid bg-white" id="kt_login">
				<!--begin::Aside-->
				<div class="login-aside d-flex flex-row-auto bgi-size-cover bgi-no-repeat p-10 p-lg-10" style="background-image: url({{asset('/public/assets/media/bg/bg-4.jpg')}});">
					<!--begin: Aside Container-->
					<div class="d-flex flex-row-fluid flex-column justify-content-between">
						<!--begin: Aside header-->
						<a href="#" class="flex-column-auto mt-5 pb-lg-0 pb-10">
							{{-- <img src="{{asset('/public/assets/media/logos/Metrical2.png')}}" class="max-h-100px" alt="" /> --}}
						</a>
						<!--end: Aside header-->
						<!--begin: Aside content-->
