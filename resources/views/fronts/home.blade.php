<x-store-front-layout>
    <div class="ps-banner">
      ...
      <div class="ps-section--features-product ps-section masonry-root pt-100">
        <div class="ps-container">
          <div class="ps-section__header mb-50">
            <h3 class="ps-section__title" data-mask="features">Features Products</h3>
            <ul class="ps-masonry__filter">
              <li class="current"><a href="{{ asset('assets/front/#')}}" data-filter="*">All <sup>{{App\Models\Product::count()}}</sup></a></li>
              @foreach (App\Models\Category::get() as $item)
              <li><a href="{{ asset('assets/front/#')}}" data-filter=".{{$item->name}} ">{{$item->name}} <sup>{{App\Models\Product::whereId($item->id)->count()}}</sup></a></li>
              @endforeach
      ...
      <div class="ps-section--sale-off ps-section  pb-40">
        <div class="ps-container">
          <div class="ps-section__header mb-50">
        ...
        <div class="ps-container">
          <div class="ps-section__header mb-50">
            <div class="row">
                  <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12 ">
                    <h3 class="ps-section__title" data-mask="BEST SALE">- Stores</h3>
                  </div>
          ...
          <div class="ps-section__content">
            <div class="ps-owl--colection owl-slider" data-owl-auto="true" data-owl-loop="true" data-owl-speed="5000" data-owl-gap="30" data-owl-nav="false" data-owl-dots="false" data-owl-item="4" data-owl-item-xs="1" data-owl-item-sm="2" data-owl-item-md="3" data-owl-item-lg="4" data-owl-duration="1000" data-owl-mousedrag="on">
              @foreach (App\Models\User::with('type_of_vendor')->where('type', 2)->get() as $item)
              <div class="ps-shoes--carousel">
                <div class="ps-shoe">
                  <div class="ps-shoe__content">
                    <div class="ps-shoe__variants">
                      <div class="ps-shoe__variant normal"><img src="{{ $item->image_url}}" alt=""><img src="{{ $item->image_url}}" alt=""><img src="{{ asset('assets/front/images/shoe/4.jpg')}}" alt=""><img src="{{ asset('assets/front/images/shoe/5.jpg')}}" alt=""></div>
                    ...
                    <div class="ps-shoe__detail"><a class="ps-shoe__name" href="{{route('home.showVendor', $item->id)}}">{{$item->name}}</a>
                      <p class="ps-shoe__categories"><a href="{{route('home.showVendor', $item->id)}}">{{$item->type_of_vendor->name}}</a></span>
                    </div>
                  </div>
                </div>
              </div>
