    ...
    $(function () {
        var table = $('#kt_datatable').DataTable({
          ...
          columns: [
              ...
              {data: 'type_of_vendor.name', name: 'type_of_vendor.name', defaultContent: "__"},
...
<script>
    $(document).on('click','.edit_item_btn',function (e) {
       ...
       var id = $(this).data("id");
        $.ajax({
            url: $("meta[name='BASE_URL']").attr("content") + '/admin/categories/' + id + '/edit', 
            type: "get", 
...
<script>
    $(document).on('click','.create_item_btn',function (e) {
       ...
       var id = $(this).data("id");
        $.ajax({
            url: $("meta[name='BASE_URL']").attr("content") + '/admin/categories/create', 
            type: "get", 
            success: function (response) {
                if(response.code ==200){
